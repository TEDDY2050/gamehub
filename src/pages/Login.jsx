  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        {/* Admin Login Hint
        <div className="mt-4 p-3 bg-blue-800/30 rounded-lg border border-blue-400/30">
          <p className="text-sm text-blue-100">
            <strong>Admin Access:</strong> username: <code className="bg-blue-900/50 px-1 rounded">admin</code> | password: <code className="bg-blue-900/50 px-1 rounded">admin123</code>
          </p>
        </div>
        */}
        </div>
